...
//   $kode=$_POST['kode'];
  ...
  if($email===$konfirmemail){
    ...
    // if($_SESSION["Captcha"]==$kode){
        ...
        if(daftarformulir($nama,$tempat,$date,$jns_kel,$agama,$nohp,$alamat,$provinsi,$no_seragam,$email,$date)){
...
<div class="container-fluid">
    ...
    <div class="row" style="margin-left:0;margin-right:0;">
        ...
        <div class="jumbotron daftar">
            ...
            <select name="no_seragam" class="form-control" required>
        ...
        <div class="jumbotron login">
            <div class="header">
                <h3 style="color:white"><center>Masuk Calon Siswa</center></h3>
            </div>
            <hr style="border:1px solid black">
