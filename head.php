...
<html lang="en">
  ...
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">SMKN4INFO</a>
    </div>
   ...
   <div class="jumbotron daftar luhur">
        <center><img src="img/logosmk.jpg" alt="" width="15%"></center>
        <h1 style="color:rgb(0, 0, 0)"><center>Pendaftaran Siswa Baru</center></h1>
        <h2 style="color:rgb(0, 0, 0)"><center>SMK NEGERI 4 BOGOR</center></h2>
