...
function tampildataortu($id){
	...
	$_SESSION['status']=isset($cek['status'])? $cek['status']:'';
...
function tampildok($id){
	...
	$cek=mysqli_fetch_array($result);
	$_SESSION['statusdok']=isset($cek['status'])? $cek['status']:'';
...
function tampilpendidikan($id){
	...
	$cek=mysqli_fetch_array($result);
	$_SESSION['statusdidik']=isset($cek['status'])? $cek['status']:'';
...
function tampilpembayaran($id){
	...
	$cek=mysqli_fetch_array($result);
	$_SESSION['statusbayar']=isset($cek['status'])? $cek['status']:'';
...
function simpanpendidikan($nama,$id_pendaftar,$status_slta,$kota,$kecamatan,$kodepos,$namaslta,$noijazah,$tahunlulus,$status){
	global $konek;

	$sql="INSERT INTO `pendidikan`(`nama_pendaftar`, `id_pendaftar`, `status_slta`, `kota`, `kecamatan`, `kode_pos`, `nama_slta`, `no_ijazah`, `tahun lulus`,`status`) VALUES('$nama','$id_pendaftar','$status_slta','$kota','$kecamatan','$kodepos','$namaslta','$noijazah','$tahunlulus','$status')";
