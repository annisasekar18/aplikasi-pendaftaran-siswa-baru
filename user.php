    ...
    <div class="col-md-6">
        ...
        <div class="block-web success-box">
            ...
            <div class="porlets-content">
                ...
                <p>Selamat, Anda telah berhasil melakukan Aktivasi Pengisian Formulir. Silahkan melakukan pembayaran sesuai dengan jumlah yang telah kami cantumkan di laman ini.</p>
                <p>Pertanyaan dan Informasi, silahkan kontak Panitia di smkn4@smkn4bogor.sch.id atau hubungi (0251)7547381.</p>
            </div>
        </div>

        <div class="header">
            <h3>Progress Pengisian Formulir</h3>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-invoice">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="border:0">
                                    <div class="text-primary"><strong>SPP (Sumbangan Pembinaan Pendidikan)</strong></div>
                                </td>
