...
if(isset($_POST['submit'])){
  ...
  if(simpanpendidikan($nama,$id_pendaftar,$status_slta,$kota,$kecamatan,$kodepos,$namaslta,$noijazah,$tahunlulus,$status)){
...
.form{
  ...
  <div class="container">
    <div class="row">
      ...
      Isilah formulir data Pendidikan ini dengan informasi yang sebenar-benarnya.
    </div>
    <br>
    <div>
    ...
    <legend>Halaman Utama</legend>
      ...
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" name="status_slta" class="form-control" placeholder="negeri/swasta">
        </div>
